  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center gap-4 flex-col w-full py-6">
        <h1 className="text-4xl font-black text-preto">Ready to bring your ideas to life?</h1>
        <p className="text-preto font-normal text-md">Get in touch with us to discuss your project and learn how we can help you achieve your goals.</p>
