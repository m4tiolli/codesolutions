...
function Footer() {
  ...
  return (
    <div className='w-full h-[15dvh] lg:h-[10dvh] border-t dark:border-zinc-800 border-[#e5e8eb] bg-[#F7FAFC] py-2 px-4 relative flex lg:flex-row flex-col-reverse items-center lg:justify-between justify-center gap-4 lg:gap-0 z-10'>
